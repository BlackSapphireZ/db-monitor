...
export default function DashboardLayout({ children }: SidebarProps) {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] flex">
            {/* Sidebar */}
            <aside className="w-56 bg-[#0f0f0f] border-r border-[#1a1a1a] flex flex-col fixed h-screen">
                {/* Logo */}
                ...
                <nav className="flex-1 py-3 overflow-y-auto">
                    ...
                    <div className="px-2 mb-1">
                        <Link
                            href="/dashboard"
                            className={`flex items-center gap-2.5 px-3 py-2 rounded-md text-sm transition ${isOverviewActive
                    ...
                    <div className="px-2 mb-1">
                        <button
                            ...
                            className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-sm text-gray-500 hover:text-gray-300 hover:bg-[#141414] transition"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {tables.map((table) => {
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className={`flex items-center justify-between px-2 py-1.5 rounded text-[13px] transition ${isActive
                                                    ? 'bg-blue-500/10 text-blue-400'
                    ...
                    <div className="px-2 mb-1">
                        <Link
                            ...
                            className={`flex items-center gap-2.5 px-3 py-2 rounded-md text-sm transition ${isQueryActive
                                    ? 'bg-blue-500/10 text-blue-400'
                                    : 'text-gray-500 hover:text-gray-300 hover:bg-[#141414]'
                                }`}
                        >
                ...
                <div className="p-3 border-t border-[#1a1a1a]">
                    <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2 text-gray-600 hover:text-gray-400 hover:bg-[#141414] rounded-md transition text-sm"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
